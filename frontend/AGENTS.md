...
This document outlines mandatory engineering standards, architectural constraints, conventions, and operational commands for AI agents and developers working on the **Open-X-Gest** frontend codebase.
